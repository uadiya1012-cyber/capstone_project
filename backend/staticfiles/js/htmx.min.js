var htmx = (function () {
  ...
  function Mn(e, t) {
    ...
    const l = t.etc.push || ne(e, "hx-push-url");
    const c = t.etc.replace || ne(e, "hx-replace-url");
