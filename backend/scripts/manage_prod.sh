...
cat <<'HINT'
Neon → Connect → Pooled connection дээрх мөрийг бүтнээр хуулж буулгана.
Бичсэн зүйл дэлгэц дээр ХАРАГДАХГҮЙ (⌘V дараад Enter). Буулгасны дараа
доор зөв орсон эсэхийг нууц үггүйгээр харуулна.
HINT
printf 'DATABASE_URL: '
